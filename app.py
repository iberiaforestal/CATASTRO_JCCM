...
if submitted:
    ...
    if not nombre or not apellidos or not dni or x == 0 or y == 0:
        ...
        vp_url = "vp_url = "https://services-eu1.arcgis.com/LVA9E9zjh6QfM7Mo/arcgis/rest/services/vias_pecuarias_poligonos/FeatureServer/1/query?outFields=*&where=1=1&f=geojson"
